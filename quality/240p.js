...
getVideoInfo(inputFilePath)
    .then(({ frameRate, totalFrames }) => {
        ffmpeg()
            .input(inputFilePath)
            .videoFilter("scale=426x240:flags=lanczos")
            .videoCodec("libx264")
            .outputOptions("-profile:v main")
            .outputOptions("-preset:v medium")
            .videoBitrate("250k")
            .outputOptions("-maxrate 250k")
            .outputOptions("-bufsize 500k")
            .outputOptions("-g 60")
            .audioCodec("aac")
            .audioBitrate("64k")
            .audioChannels(2)
            ...
            .outputOptions(`-hls_segment_filename ${outputDirectory}/240p_%03d.ts`)
            .output(`${outputDirectory}/output_240p.m3u8`)
