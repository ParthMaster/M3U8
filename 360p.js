...
getVideoInfo(inputFilePath)
    .then(({ frameRate, totalFrames }) => {
        ffmpeg()
            ...
            .outputOptions(`-hls_segment_filename ${outputDirectory}/360p_%03d.ts`)
            .output(`${outputDirectory}/output_360p.m3u8`)
