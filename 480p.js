...
getVideoInfo(inputFilePath)
    .then(({ frameRate, totalFrames }) => {
        ffmpeg()
            ...
            .outputOptions(`-hls_segment_filename ${outputDirectory}/480p_%03d.ts`)
            .output(`${outputDirectory}/output_480p.m3u8`)
